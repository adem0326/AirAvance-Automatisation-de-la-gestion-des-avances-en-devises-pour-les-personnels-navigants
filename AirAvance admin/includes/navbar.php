<?php
// Navbar component - include this at the beginning of your page
// Requires session to be started and $user_name, $user_initial variables to be set
?>
...
<nav class="top-nav">
    <div class="nav-container">
            ...
            <a href="dashboard.php" class="logo">
                <div class="logo-icon">
                    <svg fill="#000000" version="1.1" id="Capa_1" 
                                width="800px" height="800px" viewBox="0 0 123.328 123.328"
                                xml:space="preserve">
                                <g>
                                    <g>
        ...
        <div class="nav-right">
            ...
            <?php 
                // Determine logout path based on directory depth
                $depth = substr_count($_SERVER['PHP_SELF'], '/');
                $logout_path = '';
                if ($depth > 3) { // In subdirectory like /admin/ or /dcoa/
                    $logout_path = '../../auth/logout.php';
                } elseif ($depth > 2) { // In root or admin folder
                    $logout_path = '../auth/logout.php';
                } else { // In auth folder
                    $logout_path = 'logout.php';
                }
            ?>
            <a href="<?php echo $logout_path; ?>" class="btn-logout" title="Logout">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
